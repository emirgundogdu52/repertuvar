...
(function() {
  ...
  style.textContent = `
    ...
    .r-topnav img.r-logo {
      height: 55px; width: auto; max-width: 180px; flex-shrink: 0; object-fit: contain;
    }
    .r-topnav .r-tn-right {
      margin-left: auto;
  ...
  function renderSidebar() {
    ...
    aside.innerHTML = `
      <div class="sb-brand">
        <img src="${logo}" alt="repertuvar.app" style="max-width:172px;width:100%;height:auto;display:block;" data-logo="true">
      </div>
